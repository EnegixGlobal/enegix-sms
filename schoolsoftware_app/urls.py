...
urlpatterns = [
    ...
    path('salary/mark-paid/<int:pk>/', mark_salary_paid, name='mark_salary_paid'),
    path('payroll/slip/<int:pk>/', download_salary_slip, name='download_salary_slip'),
    path('salary-slip/pdf/<int:pk>/',download_salary_slip_pdf,name='download_salary_slip_pdf'),
